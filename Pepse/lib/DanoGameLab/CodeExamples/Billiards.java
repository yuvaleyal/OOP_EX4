...
public class Billiards extends GameManager {
    ...
    public void initializeGame(ImageReader imageReader, SoundReader soundReader, UserInputListener inputListener, WindowController windowController) {
        ...
        whiteBall = new WhiteBall(
                ...
                go -> {
                    ...
                    windowController.messages().showMessage(
                            "You Lose", EnumSet.of(OutputMode.MSG_BOX, OutputMode.EXIT));
                });
    ...
    public void update(float deltaTime) {
        ...
        if(remainingBalls == 0) {
            windowController.messages().showMessage(
                    "You win! "+whiteBall.hitCount()+" hits.",
                    EnumSet.of(OutputMode.MSG_BOX, OutputMode.EXIT));
        }
